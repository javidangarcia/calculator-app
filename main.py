...
class Calculator:
    def __init__(self, window):
        ...
        self.entry_value = ""
        Entry(width = 22, bg = "#ccddff", font = ("Arial Bold", 28), textvariable = self.equation).place(x = 0, y = 0)
        ...
        Button(width = 10, height = 4, text = "/", relief = "flat", bg = "white", command = lambda: self.show("/")).place(x = 270, y = 50)
        Button(width = 10, height = 4, text = "x", relief = "flat", bg = "white", command = lambda: self.show("*")).place(x = 270, y = 125)
        Button(width = 10, height = 4, text = "=", relief = "flat", bg = "lightblue", command = self.solve).place(x = 270, y = 350)
        Button(width = 10, height = 4, text = "C", relief = "flat", bg = "white", command = self.clear).place(x = 0, y = 350)
